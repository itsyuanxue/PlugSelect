...
class PatchEmbedding(nn.Module):
    def __init__(self, emb_size=40, channels=62):
        super().__init__()
        ...
        self.shallownet = nn.Sequential(
            ...
            nn.Conv2d(40, 40, (self.channels, 1), (1, 1)),
            nn.BatchNorm2d(40),
            nn.ELU(),
...
class ViT(nn.Sequential):
    def __init__(self, emb_size=40, depth=6, n_classes=4, embeddings_flag=True, channels=62,  **kwargs):
        super().__init__(
